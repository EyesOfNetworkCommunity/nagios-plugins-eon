...
my %language = ('en' => { 'A' => 'Customer',
                          ...
                          'J' => 'Author',
                          'K' => 'Comment',
                          'L' => 'EyesOfNetwork Monitoring System Notification',
                          'M' => 'Generated by EyesOfNetwork, the OpenSource monitoring solution' },
                'fr' => { 'A' => 'Utilisateur',
                          ...
                          'J' => 'Auteur',
                          'K' => 'Commentaire',
                          'L' => 'Notification de la surveillance EyesOfNetwork',
                          'M' => 'Généré par EyesOfNetwork, le système de surveillance OpenSource' },
                'de' => { 'A' => 'Anwender',
                          'B' => 'Nachrichtentyp',
                          'C' => 'Systemzustand',
                          'D' => 'Systemname',
                          ...
                          'J' => 'Author',
                          'K' => 'Kommentar',
                          'L' => 'EyesOfNetwork Überwachungssytem Meldung',
                          'M' => 'Erstellt mit EyesOfNetwork, dem OpenSource Überwachungssytem' },
                'jp' => { 'A' => '顧客名',
                          'B' => '通知の種類',
                          'C' => 'ホストの状態',
                          'D' => 'ホスト名',
                          ...
                          'J' => '投稿者',
                          'K' => 'コメント',
                          'L' => 'EyesOfNetwork 監視システムの通知',
                          'M' => 'このメッセージはオープンソースの監視システムEyesOfNetworkで生成されています。' });
